...
@ReactModule(name = LucraCreateContestButtonManager.NAME)
class LucraCreateContestButtonManager : LucraCreateContestButtonManagerSpec<View>() {
    ...
    companion object {
        const val NAME = "LucraCreateContestButton"
    }
