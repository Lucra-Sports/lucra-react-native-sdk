...
- `PUBLIC_FEED`: Opens the public feed.
- `MY_MATCHUP`: Opens the user's matchup feed.
- `DEMOGRAPHIC_COLLECTION`: Prompts the user to complete demographics.
- `CREATE_GAMES_MATCHUP`: Create a games matchup. Required params:
  - `gameid` (string): Your internal game identifier.
- `CREATE_SPORTS_MATCHUP`: Create a sports matchup. Required params:
  - `sportId` (string): Your internal sport identifier.
